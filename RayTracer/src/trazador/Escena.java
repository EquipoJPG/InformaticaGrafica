...
public class Escena {
	...
	public static ArrayList<Objeto> crear(Vector4 POV){
		...
		Plano plano1 = new Plano(p1Plano1, p2Plano1,
				p3Plano1, p4Plano1, new Material(0.5, 0.5, Color.GREEN, false, true, 10));
		
		// triangulos
		Vector4 p1Triang1 = new Vector4(0, 0, 0, 1);
		Vector4 p2Triang1 = new Vector4(-100, 100, 0, 1);
		Vector4 p3Triang1 = new Vector4(30, 30, 0, 1);
		Triangulo triangulo1 = new Triangulo(p1Plano1, p2Plano1, p3Plano1, new Material(0.8, 0.2, Color.WHITE, false, true, 1));

		Esfera esferaT1 = new Esfera(p1Plano1, 5, new Material(0.2, 0.2, Color.RED, false, false, 1));
		Esfera esferaT2 = new Esfera(p2Plano1, 5, new Material(0.2, 0.2, Color.GREEN, false, false, 1));
		Esfera esferaT3 = new Esfera(p3Plano1, 5, new Material(0.2, 0.2, Color.BLUE, false, false, 1));
		Esfera esferaT4 = new Esfera(p4Plano1, 5, new Material(0.2, 0.2, Color.WHITE, false, false, 1));
